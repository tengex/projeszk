...
public class DefaultContextController {
    ...
    public String book_list(Map<String, Object> model) {
        ...
        Book book1 = new Book("9786155638589", "367", 2017, "21. Század Kiadó", "-", "A víz mélyén", "Paula Hawkins",
                book1Copies);
        Book book2 = new Book("9786155676475", "366", 2017, "Művelt Nép Könyvkiadó", "-", "A lány akinek nincs múltja",
                "Kathryn Croft", book2Copies);
        Book book3 = new Book("9789634154686", "160", 2016, "Móra Ferenc Könyvkiadó Kft", "-", "Vidám mesék",
                "Vlagyimir Szutyejev", book3Copies);
        Book book4 = new Book("9789633999721", "352", 2017, "Könyvmolyképző Kiadó Kft", "-", "Egy kutya négy élete ",
                "W. Bruce Cameron", book4Copies);
        ...
        Book book8 = new Book("9786155617126", "526", 2016, "Művelt Nép Könyvkiadó", "-", "Egy éjszaka leplezetlenül",
                "Jodi Ellen Malpas", book8Copies);
        Book book9 = new Book("9789632936420", "208", 2014, "Athenaeum Kiadó Kft", "Magyar írók a felnőtté válásról",
                "Útra kelni ", "Peiker Éva", book9Copies);
        Book book10 = new Book("9789630796316", "750", 2016, "Európa Könyvkiadó", "Az örökség III.", "Brisingr ",
                "Christopher Paolini", book10Copies);
        Book book11 = new Book("9789632450957", "470", 2016, "Könyvmolyképző Kiadó Kft", "-", "Csontváros",
                "Clare Cassandra", book11Copies);
        Book book12 = new Book("9789632452616", "260", 2015, "Könyvmolyképző Kiadó Kft", "-", "Tizenhárom okom volt...",
                "Jay Asher", book12Copies);
        Book book13 = new Book("9789630988537", "176", 2017, "Kossuth Kiadó", "-", "A különlegesek regéi",
                "Ransom Riggs", book13Copies);
        Book book14 = new Book("9789634430773", "173", 2017, "Publio Kiadó", "-", "A varázsgömb titka", "Lovász Erika",
                book14Copies);
        ...
        book2.setBookId(new Long(2));
        book3.setBookId(new Long(3));
        book4.setBookId(new Long(4));
        book5.setBookId(new Long(5));
        book6.setBookId(new Long(6));
        book7.setBookId(new Long(7));
        book8.setBookId(new Long(8));
        book9.setBookId(new Long(9));
        book10.setBookId(new Long(10));
        book11.setBookId(new Long(11));
        book12.setBookId(new Long(12));
        book13.setBookId(new Long(13));
        book14.setBookId(new Long(14));
        book15.setBookId(new Long(15));
        book16.setBookId(new Long(16));
        book17.setBookId(new Long(17));
